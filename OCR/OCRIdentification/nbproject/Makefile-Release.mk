...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/ocridentification: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/ocridentification ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/FeatureExtraction.o: FeatureExtraction.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FeatureExtraction.o FeatureExtraction.cpp

${OBJECTDIR}/ImageMatrix.o: ImageMatrix.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ImageMatrix.o ImageMatrix.cpp
